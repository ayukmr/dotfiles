...
# selected completion item border
...
c.colors.downloads.stop.bg = bright_black
...
# passthrough statusline
c.colors.statusbar.passthrough.fg = black
c.colors.statusbar.passthrough.bg = bright_black

# private statusline
c.colors.statusbar.private.fg = black
c.colors.statusbar.private.bg = selection

# command statusline
c.colors.statusbar.command.fg = foreground
c.colors.statusbar.command.bg = black

# private command statusline
...
c.colors.tabs.indicator.stop = bright_black
