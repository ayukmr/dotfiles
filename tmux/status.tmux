...
setw -g window-status-activity-style 'fg=#abb2bf bg=#2c323c'
setw -g window-status-bell-style     'fg=#abb2bf bg=#2c323c'
setw -g window-status-current-style  'fg=#abb2bf bg=#2c323c'
