...
set -g status-left '#[fg=#2c2e34 bg=#{?client_prefix,#61afef,#{?pane_in_mode,#98c379,#{?window_zoomed_flag,#e5c07b,#c678dd}}} bold] TMX '

# right side
set -g status-right-style  none
set -g status-right-length 250
set -g status-right '#[fg=#abb2bf bg=#3e4452]  #I:#P |  #S #[fg=#2c2e34 bg=#{?client_prefix,#61afef,#{?pane_in_mode,#98c379,#{?window_zoomed_flag,#e5c07b,#c678dd}}} bold] %I:%M '
...
set -g window-status-current-format '#[fg=#abb2bf bg=#3e4452 bold] #I:#W '
